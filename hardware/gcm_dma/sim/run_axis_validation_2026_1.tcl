puts "========== CREATE AES-GCM AXI-STREAM VALIDATION PROJECT =========="

set script_dir [file dirname [file normalize [info script]]]
set project_dir [file join $script_dir vivado_project]
set rtl_dir [file normalize [file join $script_dir .. rtl]]
set sim_dir $script_dir
set project_name zcu104_aes_gcm_axis_validation
...
add_files -fileset sim_1 -norecurse [file join $sim_dir tb_AES_GCM_AXIS.v]

set_property top AES_GCM_AXIS [get_filesets sources_1]
set_property top tb_AES_GCM_AXIS [get_filesets sim_1]
...
puts "Required final line: PASS: AES_GCM_AXIS all validation tests"
puts "Do not build the DMA bitstream until all AXI-GCM tests pass."
